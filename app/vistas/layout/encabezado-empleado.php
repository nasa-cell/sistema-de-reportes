        ...
        <div class="navbar-content">
            ...
            <ul class="navbar-menu" id="navbar-menu">
                <li class="navbar-menu-item">
                    <a href="<?php echo URL_RAIZ; ?>empleado/inicio" 
                       class="navbar-menu-link<?php echo (strpos(trim(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH), '/'), 'empleado/inicio') === 0) ? ' active' : ''; ?>" 
                       data-section="inicio">
                        🏠 Inicio
                    </a>
                </li>
                <li class="navbar-menu-item">
                    <a href="<?php echo URL_RAIZ; ?>empleado/mis-proyectos" 
                       class="navbar-menu-link<?php echo (strpos(trim(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH), '/'), 'empleado/mis-proyectos') === 0) ? ' active' : ''; ?>" 
