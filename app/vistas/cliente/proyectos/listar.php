                    ...
                    <tbody>
                        <?php foreach ($proyectos as $proyecto): ?>
                            <tr>
                                ...
                                <td><?php echo $proyecto['fecha_entrega'] ?? 'N/A'; ?></td>
                                <td class="acciones-celda">
                                    <a href="<?php echo URL_RAIZ; ?>cliente/ver-proyecto?id=<?php echo $proyecto['id_proyecto']; ?>" class="boton boton-pequeno boton-info">Ver</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
